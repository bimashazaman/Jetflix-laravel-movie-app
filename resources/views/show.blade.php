...
<div class="movie-info border-b border-gray-800">
  <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row ">
      <img src="{{'https://image.tmdb.org/t/p/w500/'.$movie['poster_path']}}" class="w-64 md:w-96" style="width: 24rem" alt="">

      <div class="ml-24">
        <h2 class="text-4xl font-semibold">{{ $movie['title'] }} </h2>
        <div class="flex flex-wrap items-center text-gray-400 text-s mt-3">
...
<h1 class="xl:font-bold">Overview</h1>
        <p class="text-gray-300 mt-8">
                {{$movie['overview']}}
        <p class="text-gray-300 mt-8 text-semibold">
          ...
          <div x-data="{ isOpen: false }">
              @if (count($movie['videos']['results']) > 0)
                  <div class="mt-12">
                      <button
                          @click="isOpen = true"
                          class="flex inline-flex items-center bg-gray-200 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150"
                      >
...
{{--                    <div class="mt-8">--}}
{{--                        <a href="#">--}}
{{--                            <img src="{{ 'https://image.tmdb.org/t/p/'.$image['file_path'] }}" alt="image1" class="hover:opacity-75 transition ease-in-out duration-150">--}}
{{--                        </a>--}}
{{--                    </div>--}}
{{--                    @endif--}}
{{--                @endforeach--}}
